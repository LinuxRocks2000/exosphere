...
export function render_background(
  ...
  window.exosphere.overlay(
    window.innerWidth / 2 - window.exosphere.board.offX,
    window.innerHeight / 2 + window.exosphere.board.offY,
...
export function ctx_fill_rect(x, y, w, h) {
  window.exosphere.ctx.fillRect(x, y, w, h);
}
